...
COMPANY_RELEASE_API_URL = "https://github.samsungds.net/api/v3/repos/bh2-min/angle-cal/releases/latest"
COMPANY_RELEASE_PAGE_URL = "https://github.samsungds.net/bh2-min/angle-cal/releases"
